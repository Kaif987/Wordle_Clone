    ...
    return (
        <div className='container text-center flex flex-col items-center'>
            ...
            <div className='max-w-md'>
                <h3 className='text-3xl py-4 font-times'>Log in or create an account</h3>
                <div className='flex flex-col gap-4 mb-6'>
                    ...
                    <h1 className='border-b border-gray-300 text-sm leading-tighter'><span className='font-semibold bg-white px-2'>or</span></h1>
                </div>
